...
Here is the source code of the focal class, including member methods and fields. The full implementation of the method where the line(s)-to-test will be provided, along with summarizations and signatures of other member methods.
...
Based on the information provided above, generate unit tests for code ${step_code} targeting the line(s)-to-test. The description of this code is ${step_desp}
...
- Avoid altering the method and the line(s) under test.
...
- Ensure that the unit test methods do test the line(s) under test.
- Target the exact line(s)-to-test provided above.
