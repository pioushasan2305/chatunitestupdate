...
2.The fields and method signatures of all classes that the line(s)-to-test relies on.
3.The package name and the imports of the file containing the line(s)-to-test.
